        ...
        {!isCollapsed && (
          <div className="px-4 pb-4 space-y-1">
            <div className="flex items-center gap-3 text-[10px] text-slate-600">
              ...
              <span>·</span>
              <Link to="/terms" onClick={handleItemClick} className="hover:text-slate-400 transition-colors">Terms</Link>
              <span>·</span>
              <Link to="/privacy" onClick={handleItemClick} className="hover:text-slate-400 transition-colors">Privacy</Link>
            </div>
